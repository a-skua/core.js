...
import { ResultInstance as Result } from "./result.ts";
 ...
 *
 * ```ts
 * const some: Option<number> = OptionInstance({ some: true, value: 1 });
 * const none: Option<number> = OptionInstance({ some: false });
 * ```
 */
